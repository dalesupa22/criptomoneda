...
/*
@Author Danny Suarez dalesupa22 Junio 06,2023
*/
...
virtual returns (bool) {
        address owner = _msgSender();
        _approve(owner, spender, _allowances[owner][spender] + 
addedValue);
        return true;
    }
...
contract SOGAMOSO is ERC20, Ownable {
    constructor() ERC20("SOGAMOSO", "SOGAMOSO") {
